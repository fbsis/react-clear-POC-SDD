...
O ícone de banco de dados no cabeçalho, identificado de forma acessível como **Gerenciar dados locais**,
abre um modal com as ações disponíveis. **Limpar monstros convocados** remove atomicamente monstros e
imagens enviadas, mantendo o banco disponível. **Limpar todo o banco de dados** exclui o IndexedDB
completo e o recria vazio. As duas ações exigem confirmação e não podem ser desfeitas.
